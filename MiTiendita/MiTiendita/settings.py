...
"""DATABASES = {
    'default': {
        ...
        'USER': '',                  # si usas autenticación Windows, pon ''
        'PASSWORD': '',              # deja vacío para autenticación integrada
        'HOST': 'DESKTOP-CEIJPA0',
        'PORT': '1433',              # puerto explícito
        'OPTIONS': {
            'driver': 'ODBC Driver 17 for SQL Server',
            'trusted_connection': 'yes',  # para autenticación Windows integrada
            'encrypt': 'no',              # para evitar problemas de cifrado
        }
    }
}
"""
