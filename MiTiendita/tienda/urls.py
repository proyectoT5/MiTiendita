...
urlpatterns = [
    ...
    path('facturacion/restar/<int:item_index>/', views.facturacion_restar_item, name='facturacion_restar_item'),
    path('facturacion/sumar/<int:item_index>/', views.facturacion_sumar_item, name='facturacion_sumar_item'),
    ...
    # ✅ ESTA ES LA RUTA IMPORTANTE DEL TICKET:
    path('facturacion/recibo/<int:id_factura>/', views.factura_recibo, name='factura_recibo'),
