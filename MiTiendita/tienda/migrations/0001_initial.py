    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(db_column='Nombre', max_length=100)),
                ('precioventa', models.DecimalField(db_column='PrecioVenta', decimal_places=2, max_digits=10)),
                ('cantidad', models.IntegerField(db_column='Cantidad', default=0)),
                ('rutafoto', models.ImageField(blank=True, db_column='rutaFoto', null=True, upload_to='productos/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_telefonocli', models.AutoField(db_column='id_telefonoCli', primary_key=True, serialize=False)),
                ('numero_telefono_c', models.CharField(db_column='numero_telefono_C', max_length=20)),
                ('id_cliente', models.ForeignKey(db_column='id_cliente', on_delete=django.db.models.deletion.DO_NOTHING, to='tienda.clientes')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('en_deuda', models.BooleanField(default=False)),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tienda.clientes')),
            ],
        ),
        migrations.CreateModel(
            name='DetalleFactura',
            fields=[
                ...
                ('id_factura', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tienda.facturas')),
                ('id_producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tienda.productos')),
            ],
        ),
        migrations.AddField(
            model_name='productos',
            name='idproveedor',
            field=models.ForeignKey(blank=True, db_column='IdProveedor', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='tienda.proveedores'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activo', models.BooleanField(db_column='Activo', default=True)),
                ('producto', models.ForeignKey(db_column='Id_Producto', on_delete=django.db.models.deletion.DO_NOTHING, to='tienda.productos')),
                ('proveedor', models.ForeignKey(db_column='Id_Proveedor', on_delete=django.db.models.deletion.DO_NOTHING, to='tienda.proveedores')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_telefonoprove', models.AutoField(db_column='id_telefonoProve', primary_key=True, serialize=False)),
                ('numero_telefono_p', models.CharField(db_column='numero_telefono_P', max_length=20)),
                ('id_proveedor', models.ForeignKey(db_column='id_Proveedor', on_delete=django.db.models.deletion.DO_NOTHING, to='tienda.proveedores')),
            ],
            options={
